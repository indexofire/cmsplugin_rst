...
mySettings = {
	...
	markupSet: [
        {name:'Level 1 Heading', key:'1', placeHolder:'Your Article Title Here...', closeWith:function(markItUp) { return miu.markdownTitle(markItUp, '=') } },
		...
		{separator:'---------------' },
		{name:'Picture', key:'P', openWith:'.. image:: '},
...
rst = {
	rstTitle: function(markItUp, char) {
		heading = '';
		n = $.trim(markItUp.selection||markItUp.placeHolder).length;
		for(i = 0; i < n; i++) {
			heading += char;
